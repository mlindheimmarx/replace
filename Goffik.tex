...
%\title{Phonology, Phonotactics, and Syntax of Modern Goffik}
%\author{Matthew Lindheim-Marx
...
%\textipa{[d]} \textgreater{} \textipa{[D]} 

%\clearpage
%\section{Appendix A: Full Text of \textit{My Immortal}}
%\clearpage
%\nolinenumbers
